...
if (page) {
  ...
  // frame1_mozilla
  {
    ...
    count = await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({ name: 'url', value: /mozilla/ }).count();
    console.log("await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({name: 'url', value: /mozilla/}).count()", count);
    expect(count).toBe(1);
    const frame1_mozilla = await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({ name: 'url', value: /mozilla/ }).get();
    console.log("await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({name: 'url', value: /mozilla/}).get()", frame1_mozilla);
    expect(frame1_mozilla).not.toBeNullOrUndefined();
    url = await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({ name: 'url', value: /mozilla/ }).url();
    console.log("await page.frame().filter({ name: 'id', value: 'frame1' }).prefer({ name: 'url', value: /mozilla/ }).url()", url);
    expect(url).toEqual(url_frame1_mozilla);
  }
  // frame1_shadowclosed 'file:///Users/sagi/Workspace/src/github/sagibrant/gogogo/tests/aut/shadowclosed.html'
  {
    const url_frame1_shadowclosed = 'file:///Users/sagi/Workspace/src/github/sagibrant/gogogo/tests/aut/shadowclosed.html';
    count = await page.frame({ url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value: '300', type: 'attribute' }).count();
    console.log("await page.frame({url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value:'300', type: 'attribute'}).count()", count);
    expect(count).toBe(1);
    const frame1_shadowclosed = await page.frame({ url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value: '300', type: 'attribute' }).nth(0).get();
    console.log("await page.frame({url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value:'300', type: 'attribute'}).nth(0).get()", frame1_shadowclosed);
    expect(frame1_shadowclosed).not.toBeNullOrUndefined();
    url = await page.frame({ url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value: '300', type: 'attribute' }).nth(0).url();
    console.log("await page.frame({ url: /shadowclosed\.html$/ }).filter({ name: 'id', value: 'frame1' }).prefer({ name: 'width', value: '300', type: 'attribute' }).nth(0).url()", url);
  ...
  // frame2 shadowopen.html
  {
    ...
    count = await page.frame({ selector: '#frame2' }).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).count();
    console.log("await page.frame({selector: '#frame2'}).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).count()", count);
    expect(count).toBe(1);
    const frame2_shadowopen = await page.frame({ selector: '#frame2' }).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).first().get();
    console.log("await page.frame({selector: '#frame2'}).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).first().get()", frame2_shadowopen);
    expect(frame2_shadowopen).not.toBeNullOrUndefined();
    url = await page.frame({ selector: '#frame2' }).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).first().url();
    console.log("await page.frame({ selector: '#frame2' }).filter({ name: 'id', value: 'frame2' }).prefer({ name: 'url', value: /shadowopen/ }).first().url()", url);
  ...
  // frame2 https://cn.bing.com/translator?setlang=zh-cn/
  {
    ...
    count = await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).count();
    console.log("await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).count()", count);
    expect(count).toBe(1);
    const frame2_translator = await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).last().get();
    console.log("await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).last().get()", frame2_translator);
    expect(frame2_translator).not.toBeNullOrUndefined();
    url = await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).last().url();
    console.log("await page.frame('#frame2').filter([{ name: 'id', value: 'frame2' }, { name: 'height', value: '200', type: 'attribute' }]).prefer({ name: 'url', value: /translator/ }).last().url()", url);
