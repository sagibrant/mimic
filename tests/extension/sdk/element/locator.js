...
if (page) {
  // #css - #frame1 - 'file:///Users/sagi/Workspace/src/github/sagibrant/gogogo/tests/aut/shadowclosed.html'
  ...
  {
    {
      ...
      console.log("await page.element({ selector: '#container1' }).element('#frame1').count()", elems_container1_frame1_count);
      ...
      console.log("await page.element({ selector: '#container1' }).element('#frame1').first().get()", elems_container1_frame1);
      ...
      console.log("await page.element({ selector: '#container1' }).element('#frame1').first().getAttribute('src')", src);
      expect(src).toEqual('shadowclosed.html');
      const contentframe_elems_container1_frame1 = await page.element({ selector: '#container1' }).element('#frame1').first().contentFrame();
      console.log("await page.element({ selector: '#container1' }).element('#frame1').first().contentFrame()", contentframe_elems_container1_frame1);
      expect(contentframe_elems_container1_frame1).not.toBeNullOrUndefined();
      const frame1_shadowclosed = await page.frame('#frame1').prefer({ name: 'src', value: 'shadowclosed.html' }).first().get();
      console.log("await page.frame('#frame1').prefer({ name: 'src', value: 'shadowclosed.html' }).first().get()", frame1_shadowclosed);
...
console.log("element locator in frame1_shadowclosed =======>");
{
  ...
  let count = await page.frame({ url: /shadowclosed\.html$/ })
    .filter({ name: 'id', value: 'frame1' })
    .prefer({ name: 'width', value: '300', type: 'attribute' })
    .nth(0)
    .element({ selector: 'input[name="aaa"]' })
    .count();
  console.log(`this aaa button is hidden inside a closed shadowdom, cannot find it:
  ...
  count = await page.frame({ url: /shadowclosed\.html$/ })
    .filter({ name: 'id', value: 'frame1' })
    .prefer({ name: 'width', value: '300', type: 'attribute' })
    .nth(0)
    .element({ selector: '#shadowdiv1' })
    .count();
  console.log(`this shadowdiv1 button is outside of the closed shadowdom, can find it
    await page.frame({ url: /shadowclosed\.html$/ })
    .filter({ name: 'id', value: 'frame1' })
    .prefer({ name: 'width', value: '300', type: 'attribute' })
    .nth(0)
  ...
  const shadowdiv1_locator = await page.frame({ url: /shadowclosed\.html$/ })
    .filter({ name: 'id', value: 'frame1' })
    .prefer({ name: 'width', value: '300', type: 'attribute' })
    .nth(0)
    .element({ selector: '#shadowdiv1' });
  ...
  const input_name_aaa = await page.frame({ url: /shadowclosed\.html$/ })
    .filter({ name: 'id', value: 'frame1' })
    .prefer({ name: 'width', value: '300', type: 'attribute' })
    .nth(0)
    .element({ selector: '#shadowdiv1' })
...
console.log("element locator in frame2_shadowopen =======>");
{
  ...
  let count = await page.frame({ selector: '#frame2' })
    ...
    .count();
  console.log(`btn1 outside the shadowdom, can find:
  ...
  count = await page.frame({ selector: '#frame2' })
    .filter({ name: 'id', value: 'frame2' })
    .prefer({ name: 'url', value: /shadowopen/ })
    .first()
    .element({ xpath: '//*[@id="btn4"]' })
    .count();
  console.log(`btn4 inside the shadowdom, cannot find:
    await page.frame({ selector: '#frame2' })
    .filter({ name: 'id', value: 'frame2' })
    .prefer({ name: 'url', value: /shadowopen/ })
    .first()
  ...
  count = await page.frame({ selector: '#frame2' })
    ...
    .count();
  console.log(`btn4 inside the shadowdom, can find by filter:
    await page.frame({ selector: '#frame2' })
    .filter({ name: 'id', value: 'frame2' })
    .prefer({ name: 'url', value: /shadowopen/ })
    .first()
  ...
  const btn4 = await page.frame({ selector: '#frame2' })
    .filter({ name: 'id', value: 'frame2' })
    .prefer({ name: 'url', value: /shadowopen/ })
    .first()
    .element()
  ...
  count = await page.frame('#frame2')
    ...
    .count();
  console.log(`link1 inside the shadowdom, use parent element and filter to locate link1:
  ...
  const link1 = await page.frame('#frame2')
    .filter({ name: 'id', value: 'frame2' })
    .prefer({ name: 'url', value: /shadowopen/ })
    .first()
    .element('#shadowdiv1')
