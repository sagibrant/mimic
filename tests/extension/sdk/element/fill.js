  ...
  try {
    ...
    // input_clear
    {
      ...
      if (inputMode === 'cdp') {
        ...
        console.log(`await page.element("#input_clear").press('Tab', ${defaultOptions ? JSON.stringify(defaultOptions) : defaultOptions});`);
      }
    ...
    // textarea_fill
    {
      ...
      if (inputMode === 'cdp') {
        ...
        console.log(`await page.element("#textarea_fill").press('Tab', ${defaultOptions ? JSON.stringify(defaultOptions) : defaultOptions});`);
      }
    ...
    // input_fill
    {
      ...
      if (inputMode === 'cdp') {
        ...
        console.log(`await page.element("#input_fill").press('Tab', ${defaultOptions ? JSON.stringify(defaultOptions) : defaultOptions});`);
      }
      ...
      console.log(`await page.element("#input_fill").click(${defaultOptions ? JSON.stringify(defaultOptions) : defaultOptions})`);
    ...
    // contenteditable_fill
    {
      ...
      if (inputMode === 'cdp') {
        ...
        console.log(`await page.element("#contenteditable_fill").press('Tab', ${defaultOptions ? JSON.stringify(defaultOptions) : defaultOptions});`);
      }
